...
if __name__ == '__main__':
    ...
    model.load_weights('/mnt/data/Development/ros/catkin_ws/src/oscar_garbage_classifier/models/squeezenet_weights_tf_dim_ordering_tf_kernels.h5', by_name=True)
    classes = []
    with open('/mnt/data/Development/ros/catkin_ws/src/oscar_garbage_classifier/src/classes.txt', 'r') as list_:
        for line in list_:
            classes.append(line.rstrip('\n'))
    server.launch(model, temp_folder='/tmp/quiver', input_folder='/mnt/data/Development/ros/catkin_ws/images')
