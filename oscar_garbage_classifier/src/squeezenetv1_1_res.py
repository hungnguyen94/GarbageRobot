...
def SqueezeNet(nb_classes, rows=227, cols=227, channels=3):
    ...
    maxpool3 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), name='pool3')(res3)
    ...
    maxpool5 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), name='pool5')(res5)
    ...
    fire9 = Dropout(p=0.3, name='dropout9')(res9)
    conv10 = Convolution2D(nb_classes, 1, 1, init='he_normal', name='conv10')(fire9)
